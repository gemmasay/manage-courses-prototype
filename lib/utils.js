...
exports.autoStoreData = function (req, res, next) {
  if (!req.session.data) {
    req.session.data = {
      ...
      'provider-code': '28E',
      'training-provider-name': 'University of Hayes',
      'address-line-1': '102 Smithsfield Road',
      'town': 'Brighton',
      'postcode': 'BN1 2BR',
      'telephone': '01273 273273',
      'email': 'admissions@someemail.net',
      'website': 'https://www.university-of-hayes.uk',
      'schools': [
        {
          id: 1,
          name: 'Calthorpe Park School',
          'website': 'http://www.calthorpepark.hants.sch.uk',
          'address-line-1': 'Hitches Lane',
          'town': 'Fleet',
          'postcode': 'GU51 5JA',
          'description': 'A secondary comprehensive school with ‘Good’ Ofsted rating'
        },
        {
          id: 2,
          name: 'Frogmore Community College',
          'website': 'http://www.frogmorecollege.co.uk',
          'address-line-1': 'Potley Hill Road',
          'town': 'Yateley',
          'postcode': 'GU46 6AG',
          'description': 'A secondary comprehensive school with ‘Good’ Ofsted rating'
        },
        {
          ...
          'website': 'https://www.court-moor.hants.sch.uk/',
          'address-line-1': 'Spring Woods',
          'town': 'Fleet',
          'postcode': 'GU52 7RY',
          'description': 'A secondary comprehensive school with ‘Good’ Ofsted rating'
        }
